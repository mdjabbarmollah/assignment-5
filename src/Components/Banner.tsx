  ...
  return (
    <div className="container mx-auto  grid grid-cols-1  md:grid-cols-12 px-[30px] items-center gap-[16px] md:gap-[32px] mt-[48px] mb-[40px] md:mt-[70px] md:mb-[112px]">
      ...
      <h2 className='text-[36px] md:text-[48px] lg:text-[60px] font-extrabold'>Build Your Ideal <br />
        <span className='[background-image:var(--brand-gradient)] bg-clip-text text-transparent'>Development Stack</span></h2>
...
compare them side by side, and put together the stack that fits your
      ...
      <button className='[background-image:var(--brand-gradient)] w-[170px] h-[42px] rounded-[8px] text-white text-[14px] '>Explore Technologies</button>
